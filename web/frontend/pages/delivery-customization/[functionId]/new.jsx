...
import { Layout, Banner, Form, FormLayout, TextField, Card, Page, Frame } from '@shopify/polaris';
...
export default function NewCustomizationPage() {
  ...
  const handleSubmit = async () => {
    ...
    if (response.status != 200) {
      ...
      console.log('Error creating delivery customization: ', errorResponse.error);
    } else {
      redirect();
    }
    setIsLoading(false);
                ...
                <FormLayout>
                  <FormLayout.Group condensed>
                    <TextField
                      ...
                      onChange={(value) => handleInputChange(value, 'stateProvinceCode')}
                      disabled={isLoading}
                      requiredIndicator
                    />
                  </FormLayout.Group>
